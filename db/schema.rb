...
ActiveRecord::Schema[7.1].define(version: 2025_12_11_064522) do
  ...
  create_table "habit_logs", charset: "utf8mb3", force: :cascade do |t|
  ...
  create_table "reflections", charset: "utf8mb3", force: :cascade do |t|
    ...
    t.text "reflection1"
    t.text "reflection2"
    t.index ["user_id", "review_on"], name: "index_reflections_on_user_id_and_review_on", unique: true
